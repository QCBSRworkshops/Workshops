...
Data can be messy, there are compatibility issues.

For example, sharing data from a mac to windows or between computers set up in different continents can lead to weird datasets.
